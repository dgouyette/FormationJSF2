...
public class ArticleManagedBean implements Serializable {
    ...
    public String deleteCommentaire(Commentaire commentaire){
        System.out.println("deleteCommentaire");
        currentArticle.getCommentaires().remove(commentaire);
    ...
    public String ajouterCommentaire() throws InterruptedException {
        Thread.sleep(1000);
